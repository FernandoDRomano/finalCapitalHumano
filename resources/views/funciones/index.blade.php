    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title w-100 text-center" id="exampleModalLabel">Nueva Función</h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="formAgregar" action="{{ action ('FuncionController@store', ['id' => $organizacion->id])}}" method="POST">
                {{ csrf_field() }}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title w-100 text-white text-center" id="exampleModalLabel">Editar Función</h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    function getDatosForUpdate(e){
        ...
        if (e.target.classList.contains('editar') || e.target.classList.contains('fa-edit')) {
            ...
            .then(datos => {
                ...
                formEditar.setAttribute('action', 'funciones/' + datos.id)
   ...
   function getDatosForDelete(e){
        ...
        if (e.target.classList.contains('eliminar') || e.target.classList.contains('fa-trash-alt')) {
            ...
            .then(datos => {
                ...
                formEliminar.setAttribute('action', 'funciones/'+datos.id);
            })
            .catch(error => {
                console.log(error);
            });
